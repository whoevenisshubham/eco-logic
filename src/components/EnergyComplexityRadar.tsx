...
export const EnergyComplexityRadar: React.FC = () => {
    ...
    return (
        <div className="h-full flex flex-col bg-white overflow-hidden print:overflow-visible">
            <div className="panel-header drag-handle cursor-grab active:cursor-grabbing px-5 py-3.5 flex items-center justify-between border-b border-slate-100/80 bg-slate-50/50">
                <span className="panel-title font-semibold text-[13px]">Energy vs. Complexity Radar</span>
            ...
            <div className="flex-1 min-h-[300px] min-w-[300px] p-5 relative">
                {isRunning ? (
